 ...
 * the animation, moving a shape in the animation, as well as changing the color of and resizing a
 * shape from the animation.
 */
public interface AnimationModel {

  /**
   * Add a shape (rectangle or oval) that will be used in the animation array list.
   *
   * @param shapeIndex    the order in which the shapes are added
   ...
   * @param dimensionOne  height (if rectangle) or x-radius (if oval)
   * @param dimensionTwo  width (if rectangle) or y-radius (if oval)
   * @param shapeColorObj the color (object) of the shape
   * @param startTime     the time that the shape starts to exist
   * @param endTime       the time that the shape disappears
   * @throws IllegalArgumentException if the shape to be added is neither rectangle nor oval
   */
  void addShape(int shapeIndex, String shapeName, String shapeType, double startX, double startY,
                double dimensionOne, double dimensionTwo, ShapeColor shapeColorObj,
   ...
   * @throws IllegalArgumentException if the movement is not valid (checked based on existential
   *                                  status of the shape and time frame matching between the shape
   *                                  and the animation). Additionally, it throws an exception if a
   *                                  contradictory move is trying to be made.
   */
  ...
  void resize(String shapeName, String shapeType, double fromSize1, double fromSize2,
              ...
              boolean resize) throws IllegalArgumentException;
  ...
  /**
   * This function is used to convert the animation list to frames. This array list of array list
   * ShapeAbs will then be used in the visual view. This creates a list of frames, which each
   * contain precalculated shape objects to be displayed in each time frame.
   *
  ...
  /**
   * A setter function that is used to set the dimensions of the canvas for the visual view.
   *
  ...
  /**
   * A getter function that is used to get the dimensions of the canvas for the visual view.
   *
  ...
  /**
   * This function gets a list of hashmaps that map the names of the shapes to their string
   * attributes; This is used for the SVG view.
   *
  ...
  /**
   * This function gets a list of hashmaps that map the names of the shapes to their integral/double
   * attributes; This is used for the SVG view.
   *
   * @return a list of hashmaps
   */
